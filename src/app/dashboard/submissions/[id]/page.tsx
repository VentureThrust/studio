      ...
      <div className="space-y-8">
        <div>
          <h1 className="text-3xl font-bold">
            {submission.startupName} - Due Diligence
          </h1>
          <p className="text-muted-foreground">
            Generated Report and Submitted Information
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  This is an initial draft based on the provided information.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {submission.status === 'processing' ? (
                  <div className="flex flex-col items-center gap-4 text-muted-foreground p-8 justify-center min-h-[200px] bg-secondary rounded-md">
                    ...
                    <p className="text-sm text-center">
                      This may take a few moments. The page will update
                      automatically.
                    </p>
                  </div>
                ) : (
          ...
          <div className="space-y-6 lg:sticky lg:top-24">
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="text-sm flex justify-between">
                  <strong>Industry:</strong> <span>{submission.field}</span>
                </div>
                <div className="text-sm flex justify-between">
                  <strong>Year Registered:</strong>{' '}
                  <span>{submission.yearOfRegistration}</span>
                </div>
                <div className="text-sm flex justify-between">
                  <strong>Employees:</strong>{' '}
                  <span>{submission.numberOfEmployees}</span>
                </div>
              </CardContent>
            </Card>
            <Card>
